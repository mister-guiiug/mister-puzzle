...
export const messages: Record<Locale, MsgValue> = {
  fr: {
    ...
    dashboard: {
      ...
      deleteCheckpoint: 'Supprimer ce checkpoint',
      photosTitle: 'Photos',
      ...
      quickBump: 'Pas rapide (±1 / ±10 pièces placées)',
      activityLogTitle: 'Journal des mises à jour',
      activityLogToggle: 'Afficher le journal des mises à jour',
    ...
    nav: {
      ...
      publicSort: 'Tri des puzzles publics',
      publicSortProgressDesc: 'Avancement (↓ plus avancé)',
      publicSortProgressAsc: 'Avancement (↑ moins avancé)',
      publicSortNameAsc: 'Nom (A → Z)',
      publicSortNameDesc: 'Nom (Z → A)',
  ...
  en: {
    ...
    dashboard: {
      ...
      deleteCheckpoint: 'Remove this checkpoint',
      photosTitle: 'Photos',
      addPhoto: 'Add photo',
      ...
      errorCheckpointDelete: 'Could not delete checkpoint.',
      ...
      quickBump: 'Quick steps (±1 / ±10 placed pieces)',
      activityLogTitle: 'Update log',
      activityLogToggle: 'Show update log',
    ...
    nav: {
      ...
      publicSort: 'Sort public puzzles',
      publicSortProgressDesc: 'Progress (most complete first)',
      publicSortProgressAsc: 'Progress (least complete first)',
      publicSortNameAsc: 'Name (A–Z)',
      publicSortNameDesc: 'Name (Z–A)',
